...
# takes too long, use only for L1C collections
# data = p$atmospheric_correction(data = data, method = "smac") # or use "iCor"
```

Calculate NDVI. Reduce the "bands" dimension with the well known NDVI formula.

```{r calc_ndvi, eval=FALSE}
data = p$reduce_dimension(data = data, 
                          dimension = "bands", 
...
data = p$aggregate_temporal(data = data,
                            intervals = intervals,
